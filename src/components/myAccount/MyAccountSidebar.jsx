...
import { Avatar, Box, Typography, List, ListItem, ListItemText, ListItemIcon } from '@mui/material';
...
const Sidebar = ({ CustomerDetails, setActiveComponent }) => {
  ...
  return (
    <Box sx={{ p: 2, bgcolor: 'white', borderRadius: '10px', height: '100%' }}>
      <Box sx={{ border: '1px solid #efefef', borderBottom: 'none', borderRadius: '10px' }}>
        ...
        <ListItem sx={{paddingLeft: '1.5rem', paddingRight: '1.5rem', borderBottom: '1px solid #ececec'}} button onClick={() => setActiveComponent('Orders')}>
          ...
          <ListItemText sx={{fontFamily: 'inherit'}}>Orders</ListItemText>
        </ListItem>
        <ListItem sx={{paddingLeft: '1.5rem', paddingRight: '1.5rem', borderBottom: '1px solid #ececec'}} button onClick={() => setActiveComponent('CustomerSupport')}>
          ...
          <ListItemText sx={{fontFamily: 'inherit'}}>Customer Support</ListItemText>
        </ListItem>
        <ListItem sx={{paddingLeft: '1.5rem', paddingRight: '1.5rem', borderBottom: '1px solid #ececec'}} button onClick={() => setActiveComponent('ManageReferrals')}>
          ...
          <ListItemText sx={{fontFamily: 'inherit'}}>Manage Referrals</ListItemText>
        </ListItem>
        <ListItem sx={{paddingLeft: '1.5rem', paddingRight: '1.5rem', borderBottom: '1px solid #ececec'}} button onClick={() => setActiveComponent('Addresses')}>
          ...
          <ListItemText primary="Addresses" sx={{fontFamily: 'inherit'}} />
        </ListItem>
        ...
        <ListItem sx={{paddingLeft: '1.5rem', paddingRight: '1.5rem', borderBottom: '1px solid #ececec'}} button onClick={() => setActiveComponent('LogOut')}>
