...
const Orders = () => {
  ...
  const orders = [
    ...
    { status: 'Order cancelled', icon: <OrderCancelledSvg />, date: '10th Aug 2024, 05:39 pm', price: 107.3 },
    { status: 'Order cancelled', icon: <OrderDeliveredSvg />, date: '8th Aug 2024, 08:06 pm', price: 100.97 },
    { status: 'Order cancelled', icon: <OrderCancelledSvg />, date: '8th Aug 2024, 08:06 pm', price: 1000.77 },
    { status: 'Order cancelled', icon: <OrderCancelledSvg />, date: '8th Aug 2024, 08:06 pm', price: 190.97 },
    { status: 'Order cancelled', icon: <OrderCancelledSvg />, date: '8th Aug 2024, 08:06 pm', price: 280.97 },
    { status: 'Order cancelled', icon: <OrderDeliveredSvg />, date: '8th Aug 2024, 08:06 pm', price: 300.93 },
    { status: 'Order cancelled', icon: <OrderDeliveredSvg />, date: '8th Aug 2024, 08:06 pm', price: 20.97 },
  ];
  ...
  return (
    <Box sx={{ background: '#f0f4f9', maxHeight: '500px', overflowY: 'scroll', p: 2, borderRadius: 2 }}>
      {orders.slice(0, visibleOrders).map((order, index) => (
        <Paper key={index} sx={{ my: 2, boxShadow: '0 0 #0000, 0 0 #0000, 0px 0px 0px 0px rgba(0, 0, 0, 0.1), 0px 0px 0px 0px rgba(0, 0, 0, 0.1)', borderRadius: '1rem', cursor: 'pointer'  }}>
